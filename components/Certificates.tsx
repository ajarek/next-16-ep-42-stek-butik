    ...
    <section className='p-4 container mx-auto '>
      <div className='grid grid-cols-1 md:grid-cols-3 gap-8 '>
        <div className='p-8 border border-primary rounded-xl space-y-2 shadow-sm '>
          ...
          <h3 className='font-semibold text-3xl text-background'>
            Lokalne Hodowle
          </h3>
          <p className='font-normal text-lg text-background'>
            Współpracujemy wyłącznie z certyfikowanymi gospodarstwami z Podlasia
            i Wielkopolski.
          </p>
        </div>
        <div className='p-8 border border-primary   rounded-xl space-y-2 bg-primary text-background shadow-sm'>
          ...
          <p className='font-body-md opacity-90'>
            Specjalistyczne komory z solą himalajską zapewniają koncentrację
            smaku i kruchość.
          </p>
        </div>
        <div className='p-8 border border-primary rounded-xl space-y-2 shadow-sm'>
          ...
          <p className='font-normal text-lg text-background'>
            Pełna identyfikowalność pochodzenia – od pola aż do Twojego stołu.
          </p>
        </div>
      </div>
    </section>
