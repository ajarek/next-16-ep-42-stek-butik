      ...
      <div className="container relative z-20 mx-auto w-full px-8">
        <div className="max-w-4xl">
          ...
          <div className="flex flex-col gap-3 animate-fade-up delay-300 sm:flex-row sm:flex-wrap sm:gap-4 md:gap-6">
            <Link
              href="/cuts"
              className="bg-primary text-primary-foreground w-full px-6 py-4 uppercase tracking-widest transition-all hover:brightness-110 active:scale-95 sm:w-auto sm:px-10 sm:py-5"
            >
              Kup Teraz
            </Link>
            <button className="border border-primary text-secondary w-full px-6 py-4 uppercase tracking-widest backdrop-blur-sm transition-all hover:bg-white/5 sm:w-auto sm:px-10 sm:py-5">
              Nasza Metoda
            </button>
          </div>
        </div>
